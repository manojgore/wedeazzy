...
const TentItem: any = ({ data, type }) => {
  ...
  console.log("data :", JSON.parse(data["images"])[0]);
            ...
            >
              {wishlistState.wishlistArray.some(
                ...
                <>
                  <Icon.Heart
                    weight="fill"
                    className="body2 text-white duration-500"
                  />
                </>
              ) : (
                <>
                ...
                <div className="tent-main relative flex max-sm:flex-wrap items-center justify-between rounded-2xl overflow-hidden box-shadow-sm border border-outline">
                  ...
                  <div className="infor xl:p-10 sm:p-8 p-6 flex items-center justify-between xl:gap-10 lg:gap-8 gap-4 w-full max-md:flex-wrap">
                    <div className="xl:w-2/3 md:w-1/2 w-full flex-shrink-0 ">
                      ...
                      <div className="name heading5 capitalize mt-1">
                        {data.name}
                      </div>
                      ...
                      <div className="text-title sm:mt-4 mt-3 max-xl:hidden max-sm:block">
                        Description:
                      </div>
                      <div className="text-variant1 sm:mt-2 max-xl:hidden max-sm:block">
                        {data.shortDesc}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:items-center justify-between h-full">
                      <div>
                        ...
                        <div className="sm:mt-1 md:text-center">
                          November 10 - 15
                        </div>
                      </div>
                      <div className="xl:mt-6 mt-3">
                        ...
                        <button className="button-main w-full text-center whitespace-nowrap mt-3">
                          View Details
                        </button>
                      </div>
                    </div>
                ...
                <div className="tent-main relative flex max-sm:flex-wrap items-center justify-between rounded-2xl overflow-hidden box-shadow-sm border border-outline">
                  ...
                  <div className="infor 2xl:p-9 sm:p-8 p-6 flex items-center justify-between xl:gap-7 lg:gap-5 gap-3 w-full max-md:flex-wrap">
                    <div className="2xl:w-3/5 md:w-1/2 w-full flex-shrink-0">
                      ...
                      <div className="name heading6 capitalize mt-2">
                        {data.name}
                      </div>
                      <div className="text-title sm:mt-3 mt-2 max-2xl:hidden max-sm:block">
                        Description:
                      </div>
                      <div className="text-variant1 sm:mt-1 max-2xl:hidden max-sm:block">
                        {data.shortDesc}
                      </div>
                    </div>
