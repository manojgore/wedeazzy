...
import { businessLogin } from "../../actions/business";
...
const VendorLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await businessLogin({ email: email, password: password });

    if (response.success === false) {
      toast.error(response.message);
    } else {
      toast.success("Business SignedIn successfully!");
      ...
      <div className="login-us lg:py-10 md:py-8 py-8">
        <div className="container">
          <div className="content flex items-center justify-center">
            ...
            >
              <div className="heading3 text-center">Business Login</div>
